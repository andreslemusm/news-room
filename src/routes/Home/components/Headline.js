  ...
  return (
    <section className="mw8 center mt4 mt5-ns">
      <div className="mb3-ns flex justify-between items-center">
        <h2 className={`ml3 ml4-ns ma0 ttu fw5 f4 ${category.color}`}>{category.name}</h2>
        <Link
          className="link underline mr3 mr4-ns mid-gray f6 f6-l avenir tracked-tight hover-silver"
          to={`/${category.name}`}
        >
          All news
        </Link>
